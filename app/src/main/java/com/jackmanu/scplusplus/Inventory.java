...
/**
 * Created by dougmcintosh on 8/18/16.
 */
...
public class Inventory {
    ...
    //public SkuDetails getSkuDetails(String sku) {return mSkuMap.get(sku);}
    ...
    //List<String> getAllOwnedSkus() {return new ArrayList<String>(mPurchaseMap.keySet());}
